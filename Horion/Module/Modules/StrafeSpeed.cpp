...
Strafe::Strafe() : IModule(0x0, Category::MOVEMENT, "Bhop without jump, For CPVP") {
	//registerBoolSetting("Sprinting", &this->sprint, this->sprint);

	registerFloatSetting("Speed", &this->nspeed, this->nspeed, 0.3, 1);
...
void Strafe::onTick(C_GameMode* gm) {
	float speed = 0.17f;
