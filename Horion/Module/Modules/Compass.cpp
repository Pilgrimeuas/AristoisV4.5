...
Compass2::Compass2() : IModule(0, Category::VISUAL, "Compass") {
...
const char* Compass2::getModuleName() {
	return "Compass";
}

void Compass2::onPreRender(C_MinecraftUIRenderContext* renderCtx) {
...
void Compass2::drawCenteredText(vec2_t pos, std::string text, float size, float textOpacity) {
