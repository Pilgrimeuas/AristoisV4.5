...
Scaffold::Scaffold() : IModule(0, Category::PLAYER, "Places blocks under you") {
	...
	rotations.addEntry(EnumEntry("Hive", 1));
	rotations.addEntry(EnumEntry("Down", 2));
	rotations.addEntry(EnumEntry("Back", 3));
	rotations.addEntry(EnumEntry("Silent", 4));
	rotations.addEntry(EnumEntry("None", 5));




	registerEnumSetting("Tower", &tower, 0);
	tower.addEntry(EnumEntry("Vanilla", 0));
	tower.addEntry(EnumEntry("Hive", 1));
	tower.addEntry(EnumEntry("Clip", 2));
	tower.addEntry(EnumEntry("None", 3));
	
	registerEnumSetting("Down", &downwards, 0);
	downwards.addEntry(EnumEntry("Vanilla", 0));
	downwards.addEntry(EnumEntry("None", 1));
...
void Scaffold::onTick(C_GameMode* gm) {
	...
	auto speed = moduleMgr->getModule<_2b2espeed_>();
