...
public:
	...
	bool isGapple(void) {
		if (((std::string)name.getText()).find("apple") != std::string::npos) return true;
		return false;
	}
	bool isPickaxe(void) {
	...
	bool isStrength(void) {
		if (((std::string)name.getText()).find("potion") != std::string::npos) return true;
		return false;
	}
	bool isShovel(void) {
	...
	bool isCrystal(void) {
		if (((std::string)name.getText()).find("crystal") != std::string::npos) return true;
		return false;
	}
	bool isSword(void) {
		if (((std::string)name.getText()).find("sword") != std::string::npos) return true;
